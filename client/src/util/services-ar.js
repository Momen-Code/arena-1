const services = [
	...
	},
	{
		...
		description:
			'نحن نصنع ما يمثل عميلنا بشكل ملحوظ ودقيق من خلال الهندسة المعمارية والتصميم الداخلي بما في ذلك تصميم المناظر الطبيعية والحضرية وتصميم الأثاث وانتاجه.',
		subservices: [
			{
	...
	},
	{
		...
		description:
			'نقوم بإنشاء وابتكار الأعمال الفنية ،العلامات التجارية ،تصميم العبوات ،الإعلانات التجارية وإنشاء المحتوى',
		subservices: [
			{
				title: 'اعمال فنية',
				slug: 'art-works',
