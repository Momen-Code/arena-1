		...
		<div className="project-page-container">
			...
			<div className="page-container">
					...
					>
						{PORJECT.slides &&
							PORJECT.slides.map((slide, i) => (
								<SwiperSlide key={i}>
									<img src={slide} alt={i18n.language == "ar" ? PORJECT.ar.title : PORJECT.en.title} />
								</SwiperSlide>
							))}
					</Swiper>
				</div>
				...
				<div className="slider-footer">
					<img className="circle-img" src={CircleShape} alt="" />
					<h1 className="title">{i18n.language == "ar" ? PORJECT.ar.title : PORJECT.en.title}</h1>
					<p>{i18n.language == "ar" ? PORJECT.ar.description : PORJECT.en.description}</p>
				</div>
			</div>
			<Footer />
		</div>
